...
- Inserte una gráfica en la que se vea con claridad la señal temporal, el etiquetado manual y la detección
  ...
  ####Arriba etiquetado manual, abajo etiquetado automático
  ![Captura wavesurfer](transcripcion_manual_y_auto.png)
...
- Evalúe los resultados sobre la base de datos `db.v4` con el script `vad_evaluation.pl` e inserte a 
  ...
  ![Captura wavesurfer](script_prueba_lab.png)
...
##### Señal antes de la cancelación
  ![Captura wavesurfer](prueba_in.png)
##### Señal después de la cancelación
  ![Captura wavesurfer](prueba_out.png)
